...
/**
 * Transcriptalignment1mismatchtranspose class corresponding to <code>transcriptalignment1mismatchtranspose</code> cassandra table
 */
@Table(keyspace = "cache", name = "transcriptalignment1mismatchtranspose",
        readConsistency = "QUORUM",
        writeConsistency = "QUORUM",
        caseSensitiveKeyspace = false,
        caseSensitiveTable = false)
public class Transcriptalignment1mismatchtranspose implements Serializable {
    ...
    public Transcriptalignment1mismatchtranspose() {
    }

    public Transcriptalignment1mismatchtranspose(long experimentid, long transcriptid, UUID readid, Integer count) {
