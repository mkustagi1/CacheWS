...
/**
 * Transcriptalignmentpolya class corresponding to <code>transcriptalignmentpolya</code> cassandra table
 */
@Table(keyspace = "cache", name = "transcriptalignmentpolya",
        readConsistency = "QUORUM",
        writeConsistency = "QUORUM",
        caseSensitiveKeyspace = false,
        caseSensitiveTable = false)
public class Transcriptalignmentpolya implements Serializable {
    ...
    public Transcriptalignmentpolya() {
    }

    public Transcriptalignmentpolya(UUID id) {
        this.id = id;
    }

    public Transcriptalignmentpolya(int key, long transcriptid, boolean reversecomplement, long count, UUID id, UUID readid, double score, long startcoordinate, long stopcoordinate) {
        this.key = key;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Transcriptalignmentpolya)) {
            return false;
        }
        Transcriptalignmentpolya castOther = (Transcriptalignmentpolya) other;
