...
/**
 * Transcriptalignmenttranspose class corresponding to <code>transcriptalignmenttranspose</code> cassandra table
 */
@Table(keyspace = "cache", name = "transcriptalignmenttranspose",
        readConsistency = "QUORUM",
        writeConsistency = "QUORUM",
        caseSensitiveKeyspace = false,
        caseSensitiveTable = false)
public class Transcriptalignmenttranspose implements Serializable {
    ...
    public Transcriptalignmenttranspose() {
    }

    public Transcriptalignmenttranspose(long experimentid, long transcriptid, UUID readid, Integer count) {
