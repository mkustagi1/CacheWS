...
/**
 * Transcriptalignmentbartelpolya class corresponding to <code>transcriptalignmentbartelpolya</code> cassandra table
 */
@Table(keyspace = "cache", name = "transcriptalignmentbartelpolya",
        readConsistency = "QUORUM",
        writeConsistency = "QUORUM",
        caseSensitiveKeyspace = false,
        caseSensitiveTable = false)
public class Transcriptalignmentbartelpolya implements Serializable {
    ...
    public Transcriptalignmentbartelpolya() {
    }

    public Transcriptalignmentbartelpolya(UUID id) {
        this.id = id;
    }

    public Transcriptalignmentbartelpolya(int key, long transcriptid, boolean reversecomplement, long count, UUID id, UUID readid, double score, long startcoordinate, long stopcoordinate) {
        this.key = key;
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Transcriptalignmentbartelpolya)) {
            return false;
        }
        Transcriptalignmentbartelpolya castOther = (Transcriptalignmentbartelpolya) other;
